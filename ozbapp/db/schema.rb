...
ActiveRecord::Schema.define(:version => 20130813190332) doActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "eekonto", :id => false, :force => true do |t|
    ...
    t.datetime "GueltigBis",                                                 :null => false
    t.integer  "BankID",                                                     :null => false
    t.decimal  "Kreditlimit", :precision => 5, :scale => 2, :default => 0.0, :null => false    t.decimal  "Kreditlimit", :precision => 7, :scale => 2, :default => 0.0, :null => false
    t.integer  "SachPnr"
  end
  ...
  create_table "foerdermitglied", :id => false, :force => true do |t|
    ...
    t.datetime "GueltigBis",                                                 :null => false
    t.string   "Region",         :limit => 30,                               :null => false
    t.decimal  "Foerderbeitrag",               :precision => 5, :scale => 2, :null => false    t.decimal  "Foerderbeitrag",               :precision => 7, :scale => 2, :null => false
    t.string   "MJ",             :limit => 0
    t.integer  "SachPnr"
  end
  ...
  create_table "ozbkonto", :id => false, :force => true do |t|
    ...
    t.integer  "Mnr",                                                      :null => false
    t.date     "KtoEinrDatum",                                             :null => false
    t.string   "Waehrung",     :limit => 3,                                :null => false    t.string   "WaehrungID",   :limit => 3,                                :null => false
    t.decimal  "WSaldo",                    :precision => 10, :scale => 2
    t.integer  "PSaldo"
    t.date     "SaldoDatum"
    t.integer  "SachPnr"
  ...
  add_index "ozbkonto", ["Mnr"], :name => "Mnr"
  add_index "ozbkonto", ["Waehrung"], :name => "Waehrung"  add_index "ozbkonto", ["WaehrungID"], :name => "WaehrungID"

  create_table "ozbperson", :primary_key => "Mnr", :force => true do |t|
    t.integer "UeberPnr"
    t.date    "PWAendDatum",    :null => false    t.date    "Antragsdatum",   :null => false
    t.date    "Aufnahmedatum"
    t.date    "Austrittsdatum"
    t.date    "Schulungsdatum"
    t.integer "SachPnr"
  ...
  create_table "person", :id => false, :force => true do |t|
    t.integer  "Pnr",                                         :null => false    t.datetime "GueltigVon",                                  :null => false    t.datetime "GueltigBis",                                  :null => false    t.integer  "Pnr",                                           :null => false
    t.datetime "GueltigVon",                                    :null => false
    t.datetime "GueltigBis",                                    :null => false
    t.string   "Rolle",        :limit => 0
    t.string   "Name",         :limit => 30,                  :null => false    t.string   "Vorname",      :limit => 20, :default => "",  :null => false    t.string   "Name",         :limit => 30,                    :null => false
    t.string   "Vorname",      :limit => 20, :default => "",    :null => false
    t.date     "Geburtsdatum"
    t.string   "EMail"
    t.string   "SperrKZ",      :limit => 0,  :default => "0"    t.boolean  "SperrKZ",                    :default => false
    t.integer  "SachPnr"
  end
  ...
  create_table "sonderberechtigung", :primary_key => "ID", :force => true do |t|
    t.integer "Mnr",                        :null => false
    t.string  "Email",        :limit => 40, :null => false    t.string  "EMail",        :limit => 40, :null => false
    t.string  "Berechtigung", :limit => 0,  :null => false
  end
  ...
  create_table "student", :id => false, :force => true do |t|
    t.integer  "Mnr",                         :null => false    t.datetime "GueltigVon",                  :null => false    t.datetime "GueltigBis",                  :null => false    t.string   "AusbildBez",    :limit => 30, :null => false    t.string   "InstitutName",  :limit => 30, :null => false    t.string   "Studienort",    :limit => 30, :null => false    t.date     "Studienbeginn",               :null => false    t.date     "Studienende",                 :null => false    t.string   "Abschluss",     :limit => 20, :null => false    t.integer  "Mnr",           :null => false
    t.datetime "GueltigVon",    :null => false
    t.datetime "GueltigBis",    :null => false
    t.string   "AusbildBez",    :null => false
    t.string   "InstitutName",  :null => false
  ...
  create_table "versions", :force => true do |t|    t.string   "item_type",  :null => false    t.integer  "item_id",    :null => false    t.string   "event",      :null => false    t.string   "whodunnit"    t.text     "object"    t.datetime "created_at"    t.datetime "GueltigBis"  end  add_index "versions", ["item_type", "item_id"], :name => "index_versions_on_item_type_and_item_id"  create_table "waehrung", :primary_key => "Code", :force => true do |t|
    t.string "Bezeichnung", :limit => 30, :null => false
  end
