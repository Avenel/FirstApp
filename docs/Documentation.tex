...
Die Methode \textit{set\_primary\_keys(values)} erwartet die Werte für den primären (zusammengesetzten) Schlüssel. Nach Aufruf entspricht der Wert des primären der angegebenen Werte. Abbildung \vref{listing:setPrimaryKeys} zeigt eine beispielhafte Implementierung.
...
\subsection{Modul Tests}
Ein Modul Test besteht aus drei Teile:
\begin{itemize}
