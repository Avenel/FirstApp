...
\usepackage{graphicx}
\usepackage[left=35mm, right=15mm, top=25mm]{geometry}
...
\textsc{\LARGE Testdriven Development\\am Beispiel der o/zb Webapplikation}\\[2.0cm]
...
Betreuer: Professor Dr. Frank Schaefer
